...
local TeleportSubmenu = Class(Submenu, function(
    self,
    root,
    devtools,
    worlddevtools,
    ...
    Submenu._ctor(self, root, "Teleport", "TeleportSubmenu", screen, #root + 1)
    ...
    if self.world and self.player and self.console and screen and self.player:IsAdmin() then
